...
void CPU::Execute(u8 opcode)
{
	...
	case 0x86: ADD(Mem->ReadByte(HL)); break;
	...
	case 0x8E: ADC(Mem->ReadByte(HL)); break;
	...
	case 0x96: SUB(Mem->ReadByte(HL)); break;
	...
	case 0x9E: SBC(Mem->ReadByte(HL)); break;
	...
	case 0xA6: AND(Mem->ReadByte(HL)); break;
	...
	case 0xAE: XOR(Mem->ReadByte(HL)); break;
	...
	case 0xB6: OR(Mem->ReadByte(HL)); break;
	...
	case 0xBE: CP(Mem->ReadByte(HL)); break;
...
void CPU::ExecuteCB(u8 opcode)
{
	...
	case 0x46: { BIT(0, Mem->ReadByte(HL)); tCycle += 4; Mem->UpdateTimer(4); break; }
	...
	case 0x4E: { BIT(1, Mem->ReadByte(HL)); tCycle += 4; Mem->UpdateTimer(4); break; }
	...
	case 0x56: { BIT(2, Mem->ReadByte(HL)); tCycle += 4; Mem->UpdateTimer(4); break; }
	...
	case 0x5E: { BIT(3, Mem->ReadByte(HL)); tCycle += 4; Mem->UpdateTimer(4); break; }
	...
	case 0x66: { BIT(4, Mem->ReadByte(HL)); tCycle += 4; Mem->UpdateTimer(4); break; }
	...
	case 0x6E: { BIT(5, Mem->ReadByte(HL)); tCycle += 4; Mem->UpdateTimer(4); break; }
	...
	case 0x76: { BIT(6, Mem->ReadByte(HL)); tCycle += 4; Mem->UpdateTimer(4); break; }
	...
	case 0x7E: { BIT(7, Mem->ReadByte(HL)); tCycle += 4; Mem->UpdateTimer(4); break; }
